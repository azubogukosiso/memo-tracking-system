...
const Page = () => {
    ...
    const googleLogin = async (e) => {
        try {
            ...
            const res = await signIn('googleAttendant', { callbackUrl: '/attendant' })
            if (res) {
    ...
    return (
        <>
            ...
            <form className='w-full md:w-1/2 mx-auto mt-32' onSubmit={logInAttendant}>
                <div className='mx-5'>
                    <h1 className='mb-10'>Sign In - Attendant</h1>
                    <div>
                    ...
                    <button type="submit" className={`bg-orange-500 border border-black text-white w-full p-3 rounded  active:scale-95 transition-all ${isDisabled && 'opacity-70 cursor-not-allowed'}`}>
                        {loadingActionSignIn ?
                            (

...
const DeleteMemoComponent = ({ id }) => {
    ...
    return (
        <>
            <button className="p-3 bg-orange-500 border border-black hover:bg-orange-600 text-white rounded active:scale-95 transition-all" onClick={() => deleteMemo(id)}>
                {loadingAction ?
                    (
...
export default DeleteMemoComponent